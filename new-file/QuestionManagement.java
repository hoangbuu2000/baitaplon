...
public class QuestionManagement {
    ...
    public void practiceMultipleC(Scanner scanner, int n, User u){
    ...
    public void practiceInComplete(Scanner scanner, Level lv, User u){
    ...
    public void practiceConversation(Scanner scanner, Level lv, User u){
